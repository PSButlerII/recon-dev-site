      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-5 py-24 md:grid-cols-[1.1fr_0.9fr] md:items-center lg:py-32">
        ...
        >
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-sm text-slate-700">
            ...
            Practical technical help for builders, small businesses, and ideas
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
            Recon Dev LLC helps turn unclear technical problems into working
            plans, websites, systems, documentation, and prototype-ready next
            steps.
          </p>
